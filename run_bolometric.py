...
lc = LC.read(r'data\ascii18hmx.ascii')
...
z = 0.038
# z = 0.024
lc.calcAbsMag(dm=36.01, extinction=extinction)
# lc.calcAbsMag(dm=35.178, extinction=extinction)
lc.calcLum()

print(lc)

outpath = '/Users/Shahar/sn2018hmx/SN2018hmx_BVgi_bolometric_allsources'
# outpath = '/Users/Shahar/sn2018hmx/SN2018aad_BVgri_bolometric_allsources'

t = bolometric.calculate_bolometric(lc, z, outpath, save_table_as='bolometric_tabe_SN2018hmx_BVgi')
# t = bolometric.calculate_bolometric(lc, z, outpath, save_table_as='bolometric_tabe_SN2018aad_BVgri')
...
blackbody_data.to_csv(r'results\blackbody_results_18hmx_BVgi.csv')
