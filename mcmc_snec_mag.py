...
SN_data_all_w_early = {'mag': data_mag}

sampler = mcmc_snec.emcee_fit_params(SN_data_all, n_walkers, n_steps, parameter_ranges, 'mag')
...
mcmc_snec.plot_lightcurve_with_fit(sampler.chain, SN_data_all_w_early, parameter_ranges,
                                        'mag', res_dir, n_walkers, SN_name, n_steps-1)
mcmc_snec.plot_lightcurve_with_fit(sampler.chain, SN_data_all_w_early, parameter_ranges,
                                        'mag', res_dir, n_walkers, SN_name, 0)
