...
def add_wind(K, R, Mzams, dir):
    ...
    outfile = open(os.path.join(mainfolder, 's{}_K{}_R{}.short'.format(str(Mzams), str(K), str(R))), "w")
    ...
    outfile.close()
    outfile_iso = open(os.path.join(mainfolder, 's{}_K{}_R{}.iso.dat'.format(str(Mzams), str(K), str(R))), "w")
